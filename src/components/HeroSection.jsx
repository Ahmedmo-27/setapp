...
export default function HeroSection() {
  return (
    <section className="relative min-h-screen overflow-hidden">
      ...
      {/* Content */}
      <div className="relative z-10 min-h-screen flex flex-col items-center pt-[50px]">
        {/* Setapp Logo Icon */}
        ...
        {/* Headline */}
        <h1
          className="mb-12 w-[680px] max-w-[680px] h-[204.51px] pl-[56.36px] pr-[56.64px] pb-[0.51px] font-avenir text-center text-[64px] font-bold leading-[67.84px] tracking-[1px] text-white"
        >
          Dozens of apps.
          <br />
          One subscription.
        ...
        <div className="flex items-center gap-4">
          <button className="flex h-[52px] w-[210px] items-center justify-center rounded-[6px] border border-gray-200 bg-white text-[16px] font-medium text-[#26262b] shadow-sm hover:bg-gray-50 transition-colors">
            Try free for 7 days
          </button>

          <button className="w-[62px] h-[52px] bg-white rounded-lg flex items-center justify-center hover:bg-gray-100 transition-colors">
      ...
      {/* Description */}
      <p className="mt-[28px] max-w-[320px] w-[320px] pl-[1.72px] pr-[1.28px] font-avenir text-center text-[18px] font-normal leading-[32.04px] tracking-[0] text-white">
