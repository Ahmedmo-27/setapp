  ...
  return (
    <footer className="w-full bg-footer-bg text-white font-avenir pt-[60px] pb-[40px] flex justify-center">
      <div className="w-full max-w-[1440px] px-[30px] flex flex-col items-center">
        ...
        {/* Top Section */}
        <div className="w-full max-w-[1380px] flex flex-row flex-wrap justify-between items-start gap-y-12">
          
          {/* Left Column: Logo & Subscription */}
          <div className="flex flex-col gap-[78px] w-full max-w-[460px]">
            {/* Logo */}
            <div className="w-[440px] h-[32px] relative flex items-center gap-4">
            ...
            <div className="flex flex-col gap-[24px] w-[440px]">
              <p className="text-[16px] leading-[28px] flex items-center">
              ...
              <div className="flex w-[440px] h-[50px]">
                ...
                <button className="w-[54px] h-[50px] bg-white rounded-r-[6px] flex items-center justify-center hover:bg-gray-100 transition-colors">
          ...
          <div className="w-full max-w-[690px] flex flex-row flex-wrap justify-between">
            {/* List 1 */}
            <div className="flex flex-col w-[230px] gap-[0.5px]">
              {['Home', 'How It Works', 'All Apps', 'Pricing', 'Setapp for Teams', 'Blog', 'Podcast', 'Download'].map((item) => (
                <a key={item} href="#" className="text-[16px] leading-[32px] text-white hover:text-gray-300 transition-colors">
                  {item}
                </a>
              ))}
            </div>
            ...
            {/* List 3 */}
            <div className="flex flex-col w-[230px] gap-[0.5px]">
              <a href="#" className="text-[16px] leading-[32px] text-white hover:text-gray-300 transition-colors">Getting started with Setapp</a>
              <a href="#" className="text-[16px] leading-[32px] text-white hover:text-gray-300 transition-colors">Remote access to other Mac</a>
              <div className="flex flex-col">
                <a href="#" className="text-[16px] leading-[32px] text-white hover:text-gray-300 transition-colors">Fix macOS Ventura</a>
                <a href="#" className="text-[16px] leading-[32px] text-white hover:text-gray-300 transition-colors">problems</a>
              </div>
              <a href="#" className="text-[16px] leading-[32px] text-white hover:text-gray-300 transition-colors">Best productivity apps</a>
              <a href="#" className="text-[16px] leading-[32px] text-white hover:text-gray-300 transition-colors">Best YouTube downloaders</a>
              <a href="#" className="text-[16px] leading-[32px] text-white hover:text-gray-300 transition-colors">Uninstall apps</a>
            </div>
          </div>
        </div>

        {/* Secondary Bar */}
        <div className="w-full max-w-[1360px] flex flex-row justify-between items-center mt-[45px] h-[28px]">
           {/* Left Badges */}
           ...
           <div className="flex items-center gap-2 cursor-pointer">
              {/* US Flag placeholder - circle with stars/stripes approximation or just simplified */}
        ...
        <div className="w-full max-w-[1360px] border-t border-[#E5E5E5] mt-[24px] pt-[29px] pb-[40px] flex flex-wrap justify-between items-start relative">
           ...
           {/* Social Icons */}
           <div className="flex gap-[10px] items-center opacity-45 hover:opacity-100 transition-opacity">
              {/* Facebook */}
              <a href="#" className="w-[26px] h-[26px] flex items-center justify-center">
